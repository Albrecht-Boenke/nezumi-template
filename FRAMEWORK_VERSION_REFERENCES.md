...
| `react` | `^19.2.6` | `19.2.6` | Apps and `@packages/ui` dev dependency consume via `catalog:` |
| `react-dom` | `^19.2.6` | `19.2.6` | Apps and `@packages/ui` dev dependency consume via `catalog:` |
| `tailwindcss` | `^4.2.4` | `4.2.4` | CSS-first Tailwind v4 setup |
| `@tailwindcss/postcss` | `^4.2.4` | `4.2.4` | App PostCSS integration |
| `typescript` | `^6.0.3` | `6.0.3` | `@packages/ui` typechecks source directly with `tsc --noEmit` |
...
- `@packages/ui` is source-first and internal to this monorepo. If it becomes publishable, reintroduce an explicit package build and concrete `peerDependencies` ranges.
