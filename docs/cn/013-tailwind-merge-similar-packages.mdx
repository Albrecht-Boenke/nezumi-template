---
title: tailwind-merge — Similar packages
description: Related libraries in JS and other languages; upstream doc mirror.
---
...
Previous: [Contributing](./012-tailwind-merge-contributing.mdx)
