---
title: tailwind-merge — Writing plugins
description: Third-party plugin pattern for tailwind-merge; upstream doc mirror.
---
...
-   Use the [`validators`](./009-tailwind-merge-api-reference.mdx#validators) and [`mergeConfigs`](./009-tailwind-merge-api-reference.mdx#mergeconfigs) from tailwind-merge to extend the config with magic.
...
Next: [Versioning](./011-tailwind-merge-versioning.mdx)

Previous: [API reference](./009-tailwind-merge-api-reference.mdx)
