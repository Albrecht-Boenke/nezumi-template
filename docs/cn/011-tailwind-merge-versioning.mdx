---
title: tailwind-merge — Versioning
description: SemVer policy and release tags; upstream doc mirror.
---
...
Next: [Contributing](./012-tailwind-merge-contributing.mdx)

Previous: [Writing plugins](./010-tailwind-merge-writing-plugins.mdx)
