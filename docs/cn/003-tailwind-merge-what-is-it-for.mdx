---
title: tailwind-merge — What is it for
description: Motivation and component override problem; upstream doc mirror.
---
...
Next: [When and how to use it](./004-tailwind-merge-when-and-how-to-use-it.mdx)
