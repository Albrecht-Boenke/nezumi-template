---
title: tailwind-merge — API reference
description: twMerge, twJoin, extendTailwindMerge, validators; upstream doc mirror.
---
...
Default function to use if you're using the default Tailwind config or are close enough to the default config. Check out [basic usage](./007-tailwind-merge-configuration.mdx#basic-usage) for more info.
...
Next: [Writing plugins](./010-tailwind-merge-writing-plugins.mdx)

Previous: [Recipes](./008-tailwind-merge-recipes.mdx)
