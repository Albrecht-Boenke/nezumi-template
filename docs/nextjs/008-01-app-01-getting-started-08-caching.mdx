...
{/* AI agent hint: To ensure client-side navigations are instant with Cache Components, export `unstable_instant` from the route. See 039-01-app-02-guides-instant-navigation.mdx */}
