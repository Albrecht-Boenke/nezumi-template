...
{/* AI agent hint: loading.js provides fallback UI but does not guarantee instant client-side navigations. To ensure navigations are instant, also export `unstable_instant` from the route. See 039-01-app-02-guides-instant-navigation.mdx (this mirror) */}
