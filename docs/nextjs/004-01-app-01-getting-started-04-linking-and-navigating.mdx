...
{/* AI agent hint: To ensure client-side navigations are instant, export `unstable_instant` from the route in addition to using Suspense. See 039-01-app-02-guides-instant-navigation.mdx */}
