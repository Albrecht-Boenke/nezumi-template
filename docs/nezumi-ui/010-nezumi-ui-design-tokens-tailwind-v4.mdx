...
@theme {
  ...
  /* Card tokens map to Tailwind utility namespaces */
  --radius-card: var(--radius-xl);
  --spacing-card: var(--spacing-24);
...
- [x] Card-Tokens (`--color-card`, `--color-card-border`, `--radius-card`, `--spacing-card`, `--shadow-card`)
- [x] Input-Tokens
