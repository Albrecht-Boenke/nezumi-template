...
- [ ] `app/globals.css` mit `@import "tailwindcss"`, `@source "../../../packages/ui/src/**/*.{ts,tsx}"`, optional `@source "../../../packages/ui/dist/**/*.{js,mjs}"` und `@import "@nezumi/ui/design-tokens.css"` anlegen.
